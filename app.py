...
xero = oauth.remote_app(
    ...
    scope="offline_access openid profile email accounting.transactions "
          "accounting.journals.read accounting.transactions payroll.payruns "
          "accounting.reports.read files accounting.settings.read "
          "accounting.settings accounting.attachments payroll.payslip "
          "payroll.settings files.read openid assets.read profile payroll.employees "
          "projects.read email accounting.contacts.read accounting.attachments.read "
          "projects assets accounting.contacts payroll.timesheets accounting.budgets.read",
